...
import { on_post_event, off_post_event, on_metrics_event, off_metrics_event } from "@/modules/dashboard/supabase-ws";
...
export function init_metrics_listener() {
    on_metrics_event("changed", on_change);
...
export function destroy_metrics_listener() {
    off_metrics_event("changed", on_change);
