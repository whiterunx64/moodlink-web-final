...
export function build_moodspace_loading_node() {
    const root = document.createElement("div");
    root.className =
        "bg-gray-100 rounded-lg p-4 w-full relative overflow-hidden animate-pulse";
    ...
    time.className = "h-3 w-10 shrink-0 bg-gray-300 rounded";

    header.appendChild(left);
    header.appendChild(time);

    const line1 = document.createElement("div");
    line1.className = "h-3 w-full bg-gray-300 rounded mt-3 mb-2";

    const line2 = document.createElement("div");
    line2.className = "h-4 w-16 bg-gray-300 rounded mt-2";
...
// 7 REMOVES A NODE FROM THE FEED
